...
ENV Z3_HOME /usr/bin
ENV CLASSPATH ${JAVA_HOME}/lib/tools.jar:${JARS_HOME}/jbse-0.12.0-SNAPSHOT-shaded.jar:${JARS_HOME}/tardis-master-0.3.0-SNAPSHOT.jar:${JARS_HOME}/args4j-2.32.jar:${JARS_HOME}/javaparser-core-3.15.9.jar:${JARS_HOME}/log4j-api-2.14.0.jar:${JARS_HOME}/log4j-core-2.14.0.jar:${JARS_HOME}/evosuite-shaded-1.2.1-SNAPSHOT.jar
...
RUN echo "java -Xms16G -Xmx16G -cp ${CLASSPATH} tardis.Main -evosuite ${JARS_HOME}/evosuite-shaded-1.2.1-SNAPSHOT.jar -jbse_lib ${JARS_HOME}/jbse-0.12.0-SNAPSHOT-shaded.jar -sushi_lib ${JARS_HOME}/sushi-lib-0.3.0-SNAPSHOT.jar -z3 ${Z3_HOME}/z3 \$@" >> /usr/local/bin/tardis
