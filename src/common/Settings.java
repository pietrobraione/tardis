...
public final class Settings {
	//Massimo's settings
	public static final Path JBSE_PATH      = Paths.get("D:/jbse-master", "bin");
	public static final Path JRE_PATH		= Paths.get(JBSE_PATH.toString() + "/../data/jre/rt.jar");
	...
	public static final Path Z3_PATH        = Paths.get("D:/", "z3-master", "build", "z3");
	public static final Path WORKSPACE      = Paths.get("D:/EclipseNeon/Workspace/jbse-concolic");
	
	/*
	//Pietro's settings
	public static final Path JBSE_PATH      = Paths.get("/Users", "pietro", "git", "sushi", "bin");
	public static final Path EVOSUITE_PATH  = Paths.get("/Users", "pietro", "git", "sushi", "lib", "evosuite-shaded-1.0.3.jar");
	public static final Path SUSHI_LIB_PATH = Paths.get("/Users", "pietro", "git", "sushi-lib", "bin");
