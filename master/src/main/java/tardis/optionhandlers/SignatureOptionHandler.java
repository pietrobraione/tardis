...
public class SignatureOptionHandler extends DelimitedOptionHandler<String> {
	private static final String SIGNATURE_SEPARATOR = ":";
	public SignatureOptionHandler(CmdLineParser parser, OptionDef option, Setter<? super String> setter) {
