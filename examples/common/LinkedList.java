...
import static jbse.meta.Analysis.isResolved;
...
//MODI BEGIN
	...
	private int _initialModCount; //modCount is inherited
...
//MODI BEGIN
     ...
     */
	@SuppressWarnings("unused")
	private static void _got_LinkedList_Entry_nonroot(LinkedList.Entry<?> e) {
		//_owner is resolved (always by alias!) by LICS rules upon first access below
		++e._owner._minSize;
		assume(e._owner._initialSize >= e._owner._minSize);
	}

	@SuppressWarnings("unused")
	private static void _handleListClosure(LinkedList.Entry<?> e) {
		assume(e._owner._initialSize == e._owner._minSize);
	}
    ...
    boolean nonNullPointers_conservative() {
    	return (!isResolved(this, "next") || next != null) && 
    		   (!isResolved(this, "previous") || previous != null);
    }

    boolean repOK_conservative() {
    	return !isResolved(this, "next") || 
    		   !isResolved(this.next, "previous") || 
    		   next.previous == this; 
    }
//MODI END
...
//MODI BEGIN
	...
	Entry(E element, Entry<E> next, Entry<E> previous, LinkedList<E> _owner) {
//MODI END
