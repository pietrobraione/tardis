...
public class RunJBSEConcolic_processNodeNodeSimpFinder {
	...
	public static void main(String[] s) throws IOException, ParseException {
		...
		final String parametersSignature1 = "(Lcom/google/javascript/rhino/Node;Lcom/google/javascript/rhino/Node;Lcom/google/javascript/jscomp/SimpleDefinitionFinder;)V";
		final String methodName1 = "process";
		
		final String testClass = "com/google/javascript/jscomp/Test5";
		...
		final Path[] classPath = {Settings.BIN_PATH, Settings.JBSE_PATH, Settings.GUAVA, Settings.RHINO};		
