...
public class RunJBSEConcolicGantt_removeImplicit {
	public static void main(String[] s) throws IOException {
		final String className = "ganttproject/DependencyGraph";
		final String parametersSignature1 = "(Lganttproject/Node;)Z";
		final String methodName1 = "removeImplicitDependencies";
		
	//	final String parametersSignature1 = "()V";
	//	final String methodName1 = "rollbackTransaction";
	//	final String methodName1 = "startTransaction";
		
		final String testClass = "ganttproject/Test1";
		final String testMethodSignature = "()V";
		final String testMethod = "test0";
		final int maxDepth = 30;	//30
		final int numOfThreads = 20; //20
		final long timeBudgetDuration = 120;	//60
